...
#define NV_DEVICE_PATH           "/dev/nvidia%d"
#define NV_CTL_DEVICE_PATH       "/dev/nvidiactl"
#define NV_UVM_DEVICE_PATH       "/dev/nvidia-uvm"
#define NV_UVM_TOOLS_DEVICE_PATH "/dev/nvidia-uvm-tools"
#define NV_PERSISTENCED_SOCKET   "/var/run/nvidia-persistenced/socket"
#define NV_MPS_PIPE_DIR          "/tmp/nvidia-mps"
